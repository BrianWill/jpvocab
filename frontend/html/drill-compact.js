...
const words = [
  { word: '走る', reading: 'はしる', meaning: 'to run', type: 'verb', exampleJp: '公園を走る。', exampleEn: '"I run in the park."' },
  { word: '美しい', reading: 'うつくしい', meaning: 'beautiful', type: 'i-adjective', exampleJp: '美しい花が咲いている。', exampleEn: '"Beautiful flowers are blooming."' },
  { word: '話す', reading: 'はなす', meaning: 'to speak; to talk', type: 'verb', exampleJp: '日本語を話す。', exampleEn: '"I speak Japanese."' },
  { word: '静か', reading: 'しずか', meaning: 'quiet', type: 'na-adjective', exampleJp: '図書館は静かだ。', exampleEn: '"The library is quiet."' },
  { word: '始める', reading: 'はじめる', meaning: 'to begin; to start', type: 'verb', exampleJp: '仕事を始める。', exampleEn: '"I start work."' },
  { word: '天気', reading: 'てんき', meaning: 'weather', type: 'noun', exampleJp: '今日は天気がいい。', exampleEn: '"The weather is nice today."' },
  { word: '忘れる', reading: 'わすれる', meaning: 'to forget', type: 'verb', exampleJp: '名前を忘れる。', exampleEn: '"I forget the name."' },
  { word: '危ない', reading: 'あぶない', meaning: 'dangerous', type: 'i-adjective', exampleJp: 'この道は危ない。', exampleEn: '"This road is dangerous."' },
  { word: '選ぶ', reading: 'えらぶ', meaning: 'to choose; to select', type: 'verb', exampleJp: '好きな色を選ぶ。', exampleEn: '"I choose my favorite color."' },
  ...
  { word: '借りる', reading: 'かりる', meaning: 'to borrow', type: 'verb', exampleJp: '本を借りる。', exampleEn: '"I borrow a book."' },
  { word: '経験', reading: 'けいけん', meaning: 'experience', type: 'noun', exampleJp: 'いい経験になった。', exampleEn: '"It became a good experience."' },
  { word: '集める', reading: 'あつめる', meaning: 'to collect; to gather', type: 'verb', exampleJp: '切手を集める。', exampleEn: '"I collect stamps."' },
  { word: '複雑', reading: 'ふくざつ', meaning: 'complicated; complex', type: 'na-adjective', exampleJp: 'この地図は複雑だ。', exampleEn: '"This map is complicated."' },
  { word: '届く', reading: 'とどく', meaning: 'to arrive; to reach', type: 'verb', exampleJp: '手紙が届く。', exampleEn: '"The letter arrives."' },
  ...
  { word: '伝える', reading: 'つたえる', meaning: 'to convey; to tell', type: 'verb', exampleJp: '気持ちを伝える。', exampleEn: '"I convey my feelings."' },
  { word: '丁寧', reading: 'ていねい', meaning: 'polite; careful', type: 'na-adjective', exampleJp: '丁寧に説明する。', exampleEn: '"I explain politely."' },
  { word: '探す', reading: 'さがす', meaning: 'to search; to look for', type: 'verb', exampleJp: '鍵を探す。', exampleEn: '"I look for the key."' },
  { word: '景色', reading: 'けしき', meaning: 'scenery; view', type: 'noun', exampleJp: '景色がきれいだ。', exampleEn: '"The scenery is beautiful."' },
  { word: '壊れる', reading: 'こわれる', meaning: 'to break (intransitive)', type: 'verb', exampleJp: '時計が壊れる。', exampleEn: '"The clock breaks."' },
  ...
  { word: '誘う', reading: 'さそう', meaning: 'to invite', type: 'verb', exampleJp: '友達を誘う。', exampleEn: '"I invite a friend."' },
  ...
  { word: '受ける', reading: 'うける', meaning: 'to receive; to take (exam)', type: 'verb', exampleJp: '試験を受ける。', exampleEn: '"I take an exam."' },
  { word: '自由', reading: 'じゆう', meaning: 'freedom; free', type: 'na-adjective', exampleJp: '自由な時間が欲しい。', exampleEn: '"I want free time."' },
  { word: '捨てる', reading: 'すてる', meaning: 'to throw away', type: 'verb', exampleJp: 'ゴミを捨てる。', exampleEn: '"I throw away the trash."' },
  // New words
  { word: '泳ぐ', reading: 'およぐ', meaning: 'to swim', type: 'verb', exampleJp: '海で泳ぐ。', exampleEn: '"I swim in the sea."' },
  { word: '運ぶ', reading: 'はこぶ', meaning: 'to carry', type: 'verb', exampleJp: '荷物を運ぶ。', exampleEn: '"I carry the luggage."' },
  { word: '起きる', reading: 'おきる', meaning: 'to wake up; to get up', type: 'verb', exampleJp: '早く起きる。', exampleEn: '"I wake up early."' },
  { word: '落ちる', reading: 'おちる', meaning: 'to fall', type: 'verb', exampleJp: '葉が落ちる。', exampleEn: '"The leaves fall."' },
  { word: '変える', reading: 'かえる', meaning: 'to change', type: 'verb', exampleJp: '計画を変える。', exampleEn: '"I change the plan."' },
  { word: '考える', reading: 'かんがえる', meaning: 'to think; to consider', type: 'verb', exampleJp: '答えを考える。', exampleEn: '"I think of the answer."' },
  { word: '決める', reading: 'きめる', meaning: 'to decide', type: 'verb', exampleJp: '目標を決める。', exampleEn: '"I decide on a goal."' },
  { word: '聞こえる', reading: 'きこえる', meaning: 'to be audible; to hear', type: 'verb', exampleJp: '音楽が聞こえる。', exampleEn: '"I can hear the music."' },
  { word: '比べる', reading: 'くらべる', meaning: 'to compare', type: 'verb', exampleJp: '値段を比べる。', exampleEn: '"I compare the prices."' },
  { word: '困る', reading: 'こまる', meaning: 'to be troubled; to be in a fix', type: 'verb', exampleJp: '道に迷って困る。', exampleEn: '"I am troubled after getting lost."' },
  { word: '転ぶ', reading: 'ころぶ', meaning: 'to fall down; to tumble', type: 'verb', exampleJp: '滑って転ぶ。', exampleEn: '"I slip and fall down."' },
  { word: '触る', reading: 'さわる', meaning: 'to touch', type: 'verb', exampleJp: '猫に触る。', exampleEn: '"I touch the cat."' },
  { word: '調べる', reading: 'しらべる', meaning: 'to investigate; to look up', type: 'verb', exampleJp: '言葉を調べる。', exampleEn: '"I look up the word."' },
  { word: '信じる', reading: 'しんじる', meaning: 'to believe', type: 'verb', exampleJp: '友達を信じる。', exampleEn: '"I believe my friend."' },
  { word: '育てる', reading: 'そだてる', meaning: 'to raise; to bring up', type: 'verb', exampleJp: '子供を育てる。', exampleEn: '"I raise a child."' },
  { word: '続ける', reading: 'つづける', meaning: 'to continue', type: 'verb', exampleJp: '練習を続ける。', exampleEn: '"I continue practicing."' },
  { word: '手伝う', reading: 'てつだう', meaning: 'to help; to assist', type: 'verb', exampleJp: '母を手伝う。', exampleEn: '"I help my mother."' },
  { word: '直す', reading: 'なおす', meaning: 'to fix; to correct', type: 'verb', exampleJp: '時計を直す。', exampleEn: '"I fix the clock."' },
  { word: '並ぶ', reading: 'ならぶ', meaning: 'to line up; to stand in a row', type: 'verb', exampleJp: '列に並ぶ。', exampleEn: '"I line up in the queue."' },
  { word: '逃げる', reading: 'にげる', meaning: 'to run away; to escape', type: 'verb', exampleJp: '危険から逃げる。', exampleEn: '"I escape from danger."' },
  { word: '脱ぐ', reading: 'ぬぐ', meaning: 'to take off (clothes)', type: 'verb', exampleJp: '靴を脱ぐ。', exampleEn: '"I take off my shoes."' },
  { word: '登る', reading: 'のぼる', meaning: 'to climb', type: 'verb', exampleJp: '山に登る。', exampleEn: '"I climb the mountain."' },
  { word: '払う', reading: 'はらう', meaning: 'to pay', type: 'verb', exampleJp: '料金を払う。', exampleEn: '"I pay the fee."' },
  { word: '減る', reading: 'へる', meaning: 'to decrease; to diminish', type: 'verb', exampleJp: '体重が減る。', exampleEn: '"My weight decreases."' },
  { word: '曲がる', reading: 'まがる', meaning: 'to turn; to bend', type: 'verb', exampleJp: '角を曲がる。', exampleEn: '"I turn the corner."' },
  { word: '守る', reading: 'まもる', meaning: 'to protect; to keep (a promise)', type: 'verb', exampleJp: 'ルールを守る。', exampleEn: '"I follow the rules."' },
  { word: '見える', reading: 'みえる', meaning: 'to be visible; can see', type: 'verb', exampleJp: '海が見える。', exampleEn: '"I can see the sea."' },
  { word: '向かう', reading: 'むかう', meaning: 'to head toward; to face', type: 'verb', exampleJp: '駅に向かう。', exampleEn: '"I head toward the station."' },
  { word: '戻る', reading: 'もどる', meaning: 'to return; to go back', type: 'verb', exampleJp: '家に戻る。', exampleEn: '"I return home."' },
  { word: '焼く', reading: 'やく', meaning: 'to bake; to grill', type: 'verb', exampleJp: 'パンを焼く。', exampleEn: '"I bake bread."' },

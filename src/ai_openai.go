...
func autoFillWordOpenAI(word, model string) (*wordAutoFill, tokenUsage, error) {
	...
	return retryJSONRequest("openai autofill", func() (string, tokenUsage, error) {
...
func autoFillWordsBatchOpenAI(words []string, model string) ([]*wordAutoFill, tokenUsage, error) {
	...
	return retryJSONRequest("openai batch autofill", func() (string, tokenUsage, error) {
		return callOpenAI(model, messages)
	}, func(text string) ([]*wordAutoFill, error) {
...
func rerollMeaningOpenAI(word, currentMeaning, model string) ([]string, tokenUsage, error) {
	...
	return retryJSONRequest("openai reroll meaning", func() (string, tokenUsage, error) {
		return callOpenAI(model, messages)
...
func rerollExamplesOpenAI(word, model string) ([]examplePair, tokenUsage, error) {
	...
	return retryJSONRequest("openai reroll examples", func() (string, tokenUsage, error) {
		return callOpenAI(model, messages)
